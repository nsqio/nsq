...
Channels and topics are *not* configured a priori. Topics are created on first
use, by publishing to the named topic. Channels are created on first use, by
subscribing to the named channel.
