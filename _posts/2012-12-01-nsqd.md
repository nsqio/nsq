...
parameter to enable binary mode where body is expected to be in the following format (the HTTP
`Content-Length` header should be sent as the total size of the POST body):
